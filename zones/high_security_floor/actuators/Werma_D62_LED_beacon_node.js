...
/**
 * Werma D62 LED Beacon - High Security Floor
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_HSF_001", location: "Executive Office A Entrance" },
  { beaconId: "BEACON_HSF_002", location: "Executive Office B Entrance" },
  { beaconId: "BEACON_HSF_003", location: "Conference Room Alpha" },
  { beaconId: "BEACON_HSF_004", location: "Conference Room Beta" },
  { beaconId: "BEACON_HSF_005", location: "High Security Corridor" },
  { beaconId: "BEACON_HSF_006", location: "Server Room A Access" },
  { beaconId: "BEACON_HSF_007", location: "Server Room B Access" },
  { beaconId: "BEACON_HSF_008", location: "Data Center Emergency Alert" },
  { beaconId: "BEACON_HSF_009", location: "Executive Floor Elevator Bay" },
  { beaconId: "BEACON_HSF_010", location: "High Security Reception Area" },
];

const serverUrl = "http://localhost:3100";

class HighSecurityFloorBeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "High Security Floor Beacon System initialized with web server control"
    );
...
// Start the High Security Floor Beacon System
const beaconSystem = new HighSecurityFloorBeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down High Security Floor Beacon System...");
