...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 9 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF9_001", location: "Office Floor 9 Corridor North" },
  { sirenId: "SIREN_OF9_002", location: "Office Floor 9 Corridor South" },
  { sirenId: "SIREN_OF9_003", location: "Office Floor 9 Corridor East" },
  { sirenId: "SIREN_OF9_004", location: "Office Floor 9 Corridor West" },
];

const serverUrl = "http://localhost:3010";

class OfficeFloor9SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 9 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3010");
      } else {
...
// Start the Office Floor 9 Siren System
const sirenSystem = new OfficeFloor9SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 9 Siren System...");
