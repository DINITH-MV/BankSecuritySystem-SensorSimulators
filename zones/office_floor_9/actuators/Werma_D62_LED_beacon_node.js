...
/**
 * Werma D62 LED Beacon - Office Floor 9
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF9_001", location: "Office Floor 9 Corridor North" },
  { beaconId: "BEACON_OF9_002", location: "Office Floor 9 Corridor South" },
  { beaconId: "BEACON_OF9_003", location: "Office Floor 9 Corridor East" },
  { beaconId: "BEACON_OF9_004", location: "Office Floor 9 Corridor West" },
];

const serverUrl = "http://localhost:3010";

class OfficeFloor9BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 9 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 9 Beacon System
const beaconSystem = new OfficeFloor9BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 9 Beacon System...");
