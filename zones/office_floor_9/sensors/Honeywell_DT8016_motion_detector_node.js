...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF9_016",
    location: "Office Floor 9 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF9_017",
    location: "Office Floor 9 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 9..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 9 Honeywell Motion Detector Nodes..."
  );
