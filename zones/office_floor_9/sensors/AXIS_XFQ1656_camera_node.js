...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF9_001", location: "Office Floor 9 Main Entrance" },
  { sensorId: "CAM_OF9_002", location: "Office Floor 9 Reception Area" },
  { sensorId: "CAM_OF9_003", location: "Office Floor 9 Open Office Area A" },
  { sensorId: "CAM_OF9_004", location: "Office Floor 9 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 9 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 9 Camera Nodes...");
