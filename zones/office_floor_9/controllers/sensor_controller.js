...
class OfficeFloor9SensorController {
  constructor() {
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 9 Sensor Controller connected to MQTT");
  ...
  triggerAlert(sensorId, alert) {
    ...
    console.log(
      `Office Floor 9 ALERT TRIGGERED: ${alert.type} - ${alert.severity}`
    );
...
// Start the Office Floor 9 Sensor Controller
const controller = new OfficeFloor9SensorController();
...
export default OfficeFloor9SensorController;
