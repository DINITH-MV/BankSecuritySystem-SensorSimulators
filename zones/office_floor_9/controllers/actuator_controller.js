...
class OfficeFloor9ActuatorController {
  constructor() {
    this.zone = "office_floor_9";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF9_001: {
          id: "SIREN_OF9_001",
          location: "Office Floor 9 Corridor North",
          active: false,
        },
        SIREN_OF9_002: {
          id: "SIREN_OF9_002",
          location: "Office Floor 9 Corridor South",
          active: false,
        },
        SIREN_OF9_003: {
          id: "SIREN_OF9_003",
          location: "Office Floor 9 Corridor East",
          active: false,
        },
        SIREN_OF9_004: {
          id: "SIREN_OF9_004",
          location: "Office Floor 9 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_9_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 9 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_9/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 9");
...
// Start the Office Floor 9 Actuator Controller
const controller = new OfficeFloor9ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 9 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor9ActuatorController;
