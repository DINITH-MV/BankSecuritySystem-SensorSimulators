...
class OfficeFloor15ActuatorController {
  constructor() {
    this.zone = "office_floor_15";
    this.serverUrl = "http://localhost:3016";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF15_001: {
          id: "SIREN_OF15_001",
          location: "Office Floor 15 Corridor North",
          active: false,
        },
        SIREN_OF15_002: {
          id: "SIREN_OF15_002",
          location: "Office Floor 15 Corridor South",
          active: false,
        },
        SIREN_OF15_003: {
          id: "SIREN_OF15_003",
          location: "Office Floor 15 Corridor East",
          active: false,
        },
        SIREN_OF15_004: {
          id: "SIREN_OF15_004",
          location: "Office Floor 15 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_15_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 15 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_15/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 15");
...
// Start the Office Floor 15 Actuator Controller
const controller = new OfficeFloor15ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 15 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor15ActuatorController;