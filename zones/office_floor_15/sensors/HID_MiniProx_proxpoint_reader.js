...
const CARD_READER_CONFIGS = [
  {
    readerId: "CARD_OF15_001",
    location: "Office Floor 15 Main Entrance",
  },
  {
    readerId: "CARD_OF15_002",
    location: "Office Floor 15 Conference Room Entrance",
  },
];
...
function generateCardReaderData(config) {
  ...
  const sensorData = {
    ...
    data: {
      ...
      accessLevel: accessGranted ? "OFFICE_FLOOR_15" : null,
...
function startCardReaders() {
  console.log("Starting Office Floor 15 HID ProxPoint Plus Card Readers...");
  ...
  console.log("All Office Floor 15 card readers started");
}

startCardReaders();

process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 15 card readers...");
  process.exit(0);
});
