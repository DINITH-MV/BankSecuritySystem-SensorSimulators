...
const CAMERA_CONFIGS = [
  {
    cameraId: "CAM_OF15_001",
    location: "Office Floor 15 Open Office Area A - Northeast Corner",
  },
  {
    cameraId: "CAM_OF15_002",
    location: "Office Floor 15 Open Office Area B - Southeast Corner",
  },
  {
    cameraId: "CAM_OF15_003",
    location: "Office Floor 15 Meeting Room A - Ceiling Mount",
  },
  {
    cameraId: "CAM_OF15_004",
    location: "Office Floor 15 Corridor - Central Junction",
  },
];
...
function startCameraSensors() {
  console.log("Starting Office Floor 15 AXIS XFQ1656 Security Cameras...");
  ...
  console.log("All Office Floor 15 security cameras started");
}

startCameraSensors();

process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 15 security cameras...");
  process.exit(0);
});
