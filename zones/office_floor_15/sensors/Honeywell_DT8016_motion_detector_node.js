...
const HONEYWELL_CONFIGS = [
  {
    sensorId: "HONEY_OF15_001",
    location: "Office Floor 15 Reception Area",
  },
  {
    sensorId: "HONEY_OF15_002",
    location: "Office Floor 15 Executive Office Entrance",
  },
];
...
function startHoneywellSensors() {
  console.log("Starting Office Floor 15 Honeywell DT8016 Motion Detectors...");
  ...
  console.log("All Office Floor 15 Honeywell sensors started");
}

startHoneywellSensors();

process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 15 Honeywell sensors...");
  process.exit(0);
});
