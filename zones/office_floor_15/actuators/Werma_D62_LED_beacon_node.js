...
/**
 * Werma D62 LED Beacon - Office Floor 15
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF15_001", location: "Office Floor 15 Corridor North" },
  { beaconId: "BEACON_OF15_002", location: "Office Floor 15 Corridor South" },
  { beaconId: "BEACON_OF15_003", location: "Office Floor 15 Corridor East" },
  { beaconId: "BEACON_OF15_004", location: "Office Floor 15 Corridor West" },
];

const serverUrl = "http://localhost:3016";

class OfficeFloor15BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 15 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 15 Beacon System
const beaconSystem = new OfficeFloor15BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 15 Beacon System...");
