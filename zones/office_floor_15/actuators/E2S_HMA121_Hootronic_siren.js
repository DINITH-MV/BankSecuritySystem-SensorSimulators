...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 15 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF15_001", location: "Office Floor 15 Corridor North" },
  { sirenId: "SIREN_OF15_002", location: "Office Floor 15 Corridor South" },
  { sirenId: "SIREN_OF15_003", location: "Office Floor 15 Corridor East" },
  { sirenId: "SIREN_OF15_004", location: "Office Floor 15 Corridor West" },
];

const serverUrl = "http://localhost:3016";

class OfficeFloor15SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 15 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3016");
      } else {
...
// Start the Office Floor 15 Siren System
const sirenSystem = new OfficeFloor15SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 15 Siren System...");
