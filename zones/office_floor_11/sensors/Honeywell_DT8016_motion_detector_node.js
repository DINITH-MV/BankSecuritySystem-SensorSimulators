...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF11_016",
    location: "Office Floor 11 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF11_017",
    location: "Office Floor 11 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 11..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 11 Honeywell Motion Detector Nodes..."
  );
