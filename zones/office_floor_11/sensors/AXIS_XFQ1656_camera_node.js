...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF11_001", location: "Office Floor 11 Main Entrance" },
  { sensorId: "CAM_OF11_002", location: "Office Floor 11 Reception Area" },
  { sensorId: "CAM_OF11_003", location: "Office Floor 11 Open Office Area A" },
  { sensorId: "CAM_OF11_004", location: "Office Floor 11 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 11 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 11 Camera Nodes...");
