...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 11 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF11_001", location: "Office Floor 11 Corridor North" },
  { sirenId: "SIREN_OF11_002", location: "Office Floor 11 Corridor South" },
  { sirenId: "SIREN_OF11_003", location: "Office Floor 11 Corridor East" },
  { sirenId: "SIREN_OF11_004", location: "Office Floor 11 Corridor West" },
];

const serverUrl = "http://localhost:3012";

class OfficeFloor11SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 11 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3012");
      } else {
...
// Start the Office Floor 11 Siren System
const sirenSystem = new OfficeFloor11SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 11 Siren System...");
