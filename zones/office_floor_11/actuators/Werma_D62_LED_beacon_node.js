...
/**
 * Werma D62 LED Beacon - Office Floor 11
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF11_001", location: "Office Floor 11 Corridor North" },
  { beaconId: "BEACON_OF11_002", location: "Office Floor 11 Corridor South" },
  { beaconId: "BEACON_OF11_003", location: "Office Floor 11 Corridor East" },
  { beaconId: "BEACON_OF11_004", location: "Office Floor 11 Corridor West" },
];

const serverUrl = "http://localhost:3012";

class OfficeFloor11BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 11 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 11 Beacon System
const beaconSystem = new OfficeFloor11BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 11 Beacon System...");
