...
class OfficeFloor11ActuatorController {
  constructor() {
    this.zone = "office_floor_11";
    this.serverUrl = "http://localhost:3012";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF11_001: {
          id: "SIREN_OF11_001",
          location: "Office Floor 11 Corridor North",
          active: false,
        },
        SIREN_OF11_002: {
          id: "SIREN_OF11_002",
          location: "Office Floor 11 Corridor South",
          active: false,
        },
        SIREN_OF11_003: {
          id: "SIREN_OF11_003",
          location: "Office Floor 11 Corridor East",
          active: false,
        },
        SIREN_OF11_004: {
          id: "SIREN_OF11_004",
          location: "Office Floor 11 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_11_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 11 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_11/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 11");
...
// Start the Office Floor 11 Actuator Controller
const controller = new OfficeFloor11ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 11 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor11ActuatorController;
