...
/**
 * Werma D62 LED Beacon - Office Floor 24
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF24_001", location: "Office Floor 24 Corridor North" },
  { beaconId: "BEACON_OF24_002", location: "Office Floor 24 Corridor South" },
  { beaconId: "BEACON_OF24_003", location: "Office Floor 24 Corridor East" },
  { beaconId: "BEACON_OF24_004", location: "Office Floor 24 Corridor West" },
];

const serverUrl = "http://localhost:3025";

class OfficeFloor24BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 24 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 24 Beacon System
const beaconSystem = new OfficeFloor24BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 24 Beacon System...");
