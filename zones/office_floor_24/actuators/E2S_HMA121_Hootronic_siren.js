...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 24 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF24_001", location: "Office Floor 24 Corridor North" },
  { sirenId: "SIREN_OF24_002", location: "Office Floor 24 Corridor South" },
  { sirenId: "SIREN_OF24_003", location: "Office Floor 24 Corridor East" },
  { sirenId: "SIREN_OF24_004", location: "Office Floor 24 Corridor West" },
];

const serverUrl = "http://localhost:3025";

class OfficeFloor24SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 24 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3025");
      } else {
...
// Start the Office Floor 24 Siren System
const sirenSystem = new OfficeFloor24SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 24 Siren System...");
