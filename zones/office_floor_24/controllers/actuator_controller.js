...
class OfficeFloor24ActuatorController {
  constructor() {
    this.zone = "office_floor_24";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF24_001: {
          id: "SIREN_OF24_001",
          location: "Office Floor 24 Corridor North",
          active: false,
        },
        SIREN_OF24_002: {
          id: "SIREN_OF24_002",
          location: "Office Floor 24 Corridor South",
          active: false,
        },
        SIREN_OF24_003: {
          id: "SIREN_OF24_003",
          location: "Office Floor 24 Corridor East",
          active: false,
        },
        SIREN_OF24_004: {
          id: "SIREN_OF24_004",
          location: "Office Floor 24 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_24_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 24 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_24/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 24");
...
// Start the Office Floor 24 Actuator Controller
const controller = new OfficeFloor24ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 24 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor24ActuatorController;
