...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF24_016",
    location: "Office Floor 24 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF24_017",
    location: "Office Floor 24 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 24..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 24 Honeywell Motion Detector Nodes..."
  );
