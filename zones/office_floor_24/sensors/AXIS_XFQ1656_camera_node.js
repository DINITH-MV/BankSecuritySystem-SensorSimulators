...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF24_001", location: "Office Floor 24 Main Entrance" },
  { sensorId: "CAM_OF24_002", location: "Office Floor 24 Reception Area" },
  { sensorId: "CAM_OF24_003", location: "Office Floor 24 Open Office Area A" },
  { sensorId: "CAM_OF24_004", location: "Office Floor 24 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 24 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 24 Camera Nodes...");
