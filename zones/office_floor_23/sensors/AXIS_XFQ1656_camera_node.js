...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF23_001", location: "Office Floor 23 Main Entrance" },
  { sensorId: "CAM_OF23_002", location: "Office Floor 23 Reception Area" },
  { sensorId: "CAM_OF23_003", location: "Office Floor 23 Open Office Area A" },
  { sensorId: "CAM_OF23_004", location: "Office Floor 23 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 23 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 23 Camera Nodes...");
