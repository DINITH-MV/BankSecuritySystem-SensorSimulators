...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 23 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF23_001", location: "Office Floor 23 Corridor North" },
  { sirenId: "SIREN_OF23_002", location: "Office Floor 23 Corridor South" },
  { sirenId: "SIREN_OF23_003", location: "Office Floor 23 Corridor East" },
  { sirenId: "SIREN_OF23_004", location: "Office Floor 23 Corridor West" },
];

const serverUrl = "http://localhost:3024";

class OfficeFloor23SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 23 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3024");
      } else {
...
// Start the Office Floor 23 Siren System
const sirenSystem = new OfficeFloor23SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 23 Siren System...");
