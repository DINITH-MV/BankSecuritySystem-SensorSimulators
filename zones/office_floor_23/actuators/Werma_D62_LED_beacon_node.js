...
/**
 * Werma D62 LED Beacon - Office Floor 23
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF23_001", location: "Office Floor 23 Corridor North" },
  { beaconId: "BEACON_OF23_002", location: "Office Floor 23 Corridor South" },
  { beaconId: "BEACON_OF23_003", location: "Office Floor 23 Corridor East" },
  { beaconId: "BEACON_OF23_004", location: "Office Floor 23 Corridor West" },
];

const serverUrl = "http://localhost:3024";

class OfficeFloor23BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 23 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 23 Beacon System
const beaconSystem = new OfficeFloor23BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 23 Beacon System...");
