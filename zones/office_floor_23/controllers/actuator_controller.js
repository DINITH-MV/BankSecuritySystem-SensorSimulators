...
class OfficeFloor23ActuatorController {
  constructor() {
    this.zone = "office_floor_23";
    this.serverUrl = "http://localhost:3024";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF23_001: {
          id: "SIREN_OF23_001",
          location: "Office Floor 23 Corridor North",
          active: false,
        },
        SIREN_OF23_002: {
          id: "SIREN_OF23_002",
          location: "Office Floor 23 Corridor South",
          active: false,
        },
        SIREN_OF23_003: {
          id: "SIREN_OF23_003",
          location: "Office Floor 23 Corridor East",
          active: false,
        },
        SIREN_OF23_004: {
          id: "SIREN_OF23_004",
          location: "Office Floor 23 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_23_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 23 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_23/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 23");
...
// Start the Office Floor 23 Actuator Controller
const controller = new OfficeFloor23ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 23 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor23ActuatorController;
