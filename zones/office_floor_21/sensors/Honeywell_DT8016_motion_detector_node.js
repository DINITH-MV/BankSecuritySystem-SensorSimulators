...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF21_016",
    location: "Office Floor 21 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF21_017",
    location: "Office Floor 21 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 21..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 21 Honeywell Motion Detector Nodes..."
  );
