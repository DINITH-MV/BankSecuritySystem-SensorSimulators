...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF21_001", location: "Office Floor 21 Main Entrance" },
  { sensorId: "CAM_OF21_002", location: "Office Floor 21 Reception Area" },
  { sensorId: "CAM_OF21_003", location: "Office Floor 21 Open Office Area A" },
  { sensorId: "CAM_OF21_004", location: "Office Floor 21 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 21 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 21 Camera Nodes...");
