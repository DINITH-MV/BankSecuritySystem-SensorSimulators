...
class OfficeFloor3ActuatorController {
  constructor() {
    this.zone = "office_floor_21";
    this.serverUrl = "http://localhost:3022";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF21_001: {
          id: "SIREN_OF21_001",
          location: "Office Floor 21 Corridor North",
          active: false,
        },
        SIREN_OF21_002: {
          id: "SIREN_OF21_002",
          location: "Office Floor 21 Corridor South",
          active: false,
        },
        SIREN_OF21_003: {
          id: "SIREN_OF21_003",
          location: "Office Floor 21 Corridor East",
          active: false,
        },
        SIREN_OF21_004: {
          id: "SIREN_OF21_004",
          location: "Office Floor 21 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_21_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 21 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_21/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 21");
...
// Start the Office Floor 21 Actuator Controller
const controller = new OfficeFloor3ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 21 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor3ActuatorController;
