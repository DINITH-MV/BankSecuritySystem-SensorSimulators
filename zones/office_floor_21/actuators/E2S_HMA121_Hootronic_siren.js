...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 21 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF21_001", location: "Office Floor 21 Corridor North" },
  { sirenId: "SIREN_OF21_002", location: "Office Floor 21 Corridor South" },
  { sirenId: "SIREN_OF21_003", location: "Office Floor 21 Corridor East" },
  { sirenId: "SIREN_OF21_004", location: "Office Floor 21 Corridor West" },
];

const serverUrl = "http://localhost:3022";

class OfficeFloor3SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 21 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3022");
      } else {
...
// Start the Office Floor 21 Siren System
const sirenSystem = new OfficeFloor3SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 21 Siren System...");
