...
/**
 * Werma D62 LED Beacon - Office Floor 21
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF21_001", location: "Office Floor 21 Corridor North" },
  { beaconId: "BEACON_OF21_002", location: "Office Floor 21 Corridor South" },
  { beaconId: "BEACON_OF21_003", location: "Office Floor 21 Corridor East" },
  { beaconId: "BEACON_OF21_004", location: "Office Floor 21 Corridor West" },
];
...
class OfficeFloor3BeaconSystem {
  constructor() {
    ...
    console.log(
      "Office Floor 21 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 21 Beacon System
const beaconSystem = new OfficeFloor3BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 21 Beacon System...");
