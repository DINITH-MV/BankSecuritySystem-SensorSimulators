...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_001", location: "North Perimeter Gate" },
  { sensorId: "CAM_002", location: "East Fence Line" },
  { sensorId: "CAM_003", location: "South Perimeter" },
  { sensorId: "CAM_004", location: "West Perimeter" },
];
...
console.log("Starting AXIS XFQ1656 Camera monitoring for 4 cameras...");
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Security Camera Nodes...");
