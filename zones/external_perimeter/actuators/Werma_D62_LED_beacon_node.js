...
/**
 * Werma D62 LED Beacon - External Perimeter
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_001", location: "North Perimeter Gate" },
  { beaconId: "BEACON_002", location: "East Fence Line" },
  { beaconId: "BEACON_003", location: "South Perimeter" },
  { beaconId: "BEACON_004", location: "West Perimeter" },
];

const serverUrl = "http://localhost:3000";

class ExternalPerimeterBeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "External Perimeter Beacon System initialized with web server control"
    );
...
// Start the External Perimeter Beacon System
const beaconSystem = new ExternalPerimeterBeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down External Perimeter Beacon System...");
