...
/**
 * E2S HMA121 Hootronic Horn - External Perimeter Siren
 * Web server controlled high-power outdoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_001", location: "North Perimeter Gate" },
  { sirenId: "SIREN_002", location: "East Fence Line" },
  { sirenId: "SIREN_003", location: "South Perimeter" },
  { sirenId: "SIREN_004", location: "West Perimeter" },
];

const serverUrl = "http://localhost:3000";

class ExternalPerimeterSirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "External Perimeter Siren System initialized with web server control"
    );
...
// Start the External Perimeter Siren System
const sirenSystem = new ExternalPerimeterSirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down External Perimeter Siren System...");
