...
/**
 * Werma D62 LED Beacon - Ground Floor
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_GF_001", location: "Main Lobby Entrance" },
  { beaconId: "BEACON_GF_002", location: "Reception Desk Area" },
  { beaconId: "BEACON_GF_003", location: "Ground Floor Elevator Bay" },
  { beaconId: "BEACON_GF_004", location: "Emergency Assembly Point" },
];

const serverUrl = "http://localhost:3001";

class GroundFloorBeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Ground Floor Beacon System initialized with web server control"
    );
...
// Start the Ground Floor Beacon System
const beaconSystem = new GroundFloorBeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Ground Floor Beacon System...");
