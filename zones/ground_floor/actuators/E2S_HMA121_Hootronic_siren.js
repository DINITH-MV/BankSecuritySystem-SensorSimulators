...
/**
 * E2S HMA121 Hootronic Horn - Ground Floor Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_GF_001", location: "Main Lobby" },
  { sirenId: "SIREN_GF_002", location: "Reception Area" },
  { sirenId: "SIREN_GF_003", location: "Emergency Exit Corridor" },
  { sirenId: "SIREN_GF_004", location: "Ground Floor Stairwell" },
];

const serverUrl = "http://localhost:3001";

class GroundFloorSirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Ground Floor Siren System initialized with web server control"
    );
...
// Start the Ground Floor Siren System
const sirenSystem = new GroundFloorSirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Ground Floor Siren System...");
