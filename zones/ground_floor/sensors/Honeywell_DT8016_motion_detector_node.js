...
const MOTION_CONFIGS = [
  { sensorId: "MOTION_008", location: "Main Entrance Foyer" },
  { sensorId: "MOTION_009", location: "Security Checkpoint" },
];
...
console.log("Starting Honeywell DT8016 DualTech Motion Detector monitoring...");
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Honeywell Motion Detector Nodes...");
