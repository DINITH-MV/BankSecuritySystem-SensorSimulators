...
class GroundFloorActuatorController {
  constructor() {
    ...
    this.actuators = {
      ...
      beacons: {
        ...
        BEACON_GF_002: {
          id: "BEACON_GF_002",
          location: "Reception Desk Area",
          active: false,
        },
        BEACON_GF_003: {
          id: "BEACON_GF_003",
          location: "Ground Floor Elevator Bay",
          active: false,
        },
        BEACON_GF_004: {
          id: "BEACON_GF_004",
          location: "Emergency Assembly Point",
          active: false,
        },
      },
    };
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Ground Floor Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/ground_floor/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in ground floor");
...
// Start the Ground Floor Actuator Controller
const controller = new GroundFloorActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Ground Floor Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default GroundFloorActuatorController;
