...
/**
 * E2S HMA121 Hootronic Horn - office floor 20 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF20_001", location: "office floor 20 Corridor North" },
  { sirenId: "SIREN_OF20_002", location: "office floor 20 Corridor South" },
  { sirenId: "SIREN_OF20_003", location: "office floor 20 Corridor East" },
  { sirenId: "SIREN_OF20_004", location: "office floor 20 Corridor West" },
];

const serverUrl = "http://localhost:3021";

class OfficeFloor20SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "office floor 20 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3021");
      } else {
...
// Start the office floor 20 Siren System
const sirenSystem = new OfficeFloor20SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down office floor 20 Siren System...");
