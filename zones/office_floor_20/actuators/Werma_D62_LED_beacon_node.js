...
/**
 * Werma D62 LED Beacon - office floor 20
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF20_001", location: "office floor 20 Corridor North" },
  { beaconId: "BEACON_OF20_002", location: "office floor 20 Corridor South" },
  { beaconId: "BEACON_OF20_003", location: "office floor 20 Corridor East" },
  { beaconId: "BEACON_OF20_004", location: "office floor 20 Corridor West" },
];

const serverUrl = "http://localhost:3021";

class OfficeFloor20BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "office floor 20 Beacon System initialized with web server control"
    );
...
// Start the office floor 20 Beacon System
const beaconSystem = new OfficeFloor20BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down office floor 20 Beacon System...");
