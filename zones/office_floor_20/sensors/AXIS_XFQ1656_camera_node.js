...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF20_001", location: "office floor 20 Main Entrance" },
  { sensorId: "CAM_OF20_002", location: "office floor 20 Reception Area" },
  { sensorId: "CAM_OF20_003", location: "office floor 20 Open Office Area A" },
  { sensorId: "CAM_OF20_004", location: "office floor 20 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for office floor 20 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down office floor 20 Camera Nodes...");
