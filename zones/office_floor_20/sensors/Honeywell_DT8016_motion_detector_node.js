...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF20_016",
    location: "office floor 20 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF20_017",
    location: "office floor 20 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for office floor 20..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down office floor 20 Honeywell Motion Detector Nodes..."
  );
