...
class OfficeFloor20SensorController {
  constructor() {
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("office floor 20 Sensor Controller connected to MQTT");
  ...
  triggerAlert(sensorId, alert) {
    ...
    console.log(
      `office floor 20 ALERT TRIGGERED: ${alert.type} - ${alert.severity}`
    );
...
// Start the office floor 20 Sensor Controller
const controller = new OfficeFloor20SensorController();
...
export default OfficeFloor20SensorController;
