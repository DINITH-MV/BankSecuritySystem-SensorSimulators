...
class OfficeFloor20ActuatorController {
  constructor() {
    this.zone = "office_floor_20";
    this.serverUrl = "http://localhost:3021";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF20_001: {
          id: "SIREN_OF20_001",
          location: "office floor 20 Corridor North",
          active: false,
        },
        SIREN_OF20_002: {
          id: "SIREN_OF20_002",
          location: "office floor 20 Corridor South",
          active: false,
        },
        SIREN_OF20_003: {
          id: "SIREN_OF20_003",
          location: "office floor 20 Corridor East",
          active: false,
        },
        SIREN_OF20_004: {
          id: "SIREN_OF20_004",
          location: "office floor 20 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_20_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("office floor 20 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_20/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in office floor 20");
...
// Start the office floor 20 Actuator Controller
const controller = new OfficeFloor20ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down office floor 20 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor20ActuatorController;
