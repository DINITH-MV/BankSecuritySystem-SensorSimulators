...
class OfficeFloor3ActuatorController {
  constructor() {
    ...
    this.actuators = {
      sirens: {
        SIREN_OF3_001: {
          id: "SIREN_OF3_001",
          location: "Office Floor 3 Corridor North",
          active: false,
        },
        SIREN_OF3_002: {
          id: "SIREN_OF3_002",
          location: "Office Floor 3 Corridor South",
          active: false,
        },
        SIREN_OF3_003: {
          id: "SIREN_OF3_003",
          location: "Office Floor 3 Corridor East",
          active: false,
        },
        SIREN_OF3_004: {
          id: "SIREN_OF3_004",
          location: "Office Floor 3 Corridor West",
          active: false,
        },
      },
      beacons: {
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 3 Actuator Controller connected to MQTT");
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 3");
...
// Start the Office Floor 3 Actuator Controller
const controller = new OfficeFloor3ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 3 Actuator Controller...");
