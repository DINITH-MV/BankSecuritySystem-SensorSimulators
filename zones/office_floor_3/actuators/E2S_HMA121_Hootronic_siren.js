...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 3 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF3_001", location: "Office Floor 3 Corridor North" },
  { sirenId: "SIREN_OF3_002", location: "Office Floor 3 Corridor South" },
  { sirenId: "SIREN_OF3_003", location: "Office Floor 3 Corridor East" },
  { sirenId: "SIREN_OF3_004", location: "Office Floor 3 Corridor West" },
];
...
class OfficeFloor3SirenSystem {
  constructor() {
    ...
    console.log(
      "Office Floor 3 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3004");
      } else {
...
// Start the Office Floor 3 Siren System
const sirenSystem = new OfficeFloor3SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 3 Siren System...");
