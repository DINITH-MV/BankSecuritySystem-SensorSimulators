...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF3_001", location: "Office Floor 3 Main Entrance" },
  { sensorId: "CAM_OF3_002", location: "Office Floor 3 Reception Area" },
  { sensorId: "CAM_OF3_003", location: "Office Floor 3 Open Office Area A" },
  { sensorId: "CAM_OF3_004", location: "Office Floor 3 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 3 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 3 Camera Nodes...");
