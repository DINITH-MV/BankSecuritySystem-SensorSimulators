...
const MOTION_CONFIGS = [
  {
    ...
    location: "Office Floor 3 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF3_017",
    location: "Office Floor 3 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 3..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 3 Honeywell Motion Detector Nodes..."
  );
