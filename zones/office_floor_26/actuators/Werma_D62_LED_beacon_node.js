...
/**
 * Werma D62 LED Beacon - Office Floor 26
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF26_001", location: "Office Floor 26 Corridor North" },
  { beaconId: "BEACON_OF26_002", location: "Office Floor 26 Corridor South" },
  { beaconId: "BEACON_OF26_003", location: "Office Floor 26 Corridor East" },
  { beaconId: "BEACON_OF26_004", location: "Office Floor 26 Corridor West" },
];

const serverUrl = "http://localhost:3027";

class OfficeFloor26BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 26 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 26 Beacon System
const beaconSystem = new OfficeFloor26BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 26 Beacon System...");
