...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 26 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF26_001", location: "Office Floor 26 Corridor North" },
  { sirenId: "SIREN_OF26_002", location: "Office Floor 26 Corridor South" },
  { sirenId: "SIREN_OF26_003", location: "Office Floor 26 Corridor East" },
  { sirenId: "SIREN_OF26_004", location: "Office Floor 26 Corridor West" },
];

const serverUrl = "http://localhost:3027";

class OfficeFloor26SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 26 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3027");
      } else {
...
// Start the Office Floor 26 Siren System
const sirenSystem = new OfficeFloor26SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 26 Siren System...");
