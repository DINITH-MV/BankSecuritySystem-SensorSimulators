...
class OfficeFloor26ActuatorController {
  constructor() {
    this.zone = "office_floor_26";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF26_001: {
          id: "SIREN_OF26_001",
          location: "Office Floor 26 Corridor North",
          active: false,
        },
        SIREN_OF26_002: {
          id: "SIREN_OF26_002",
          location: "Office Floor 26 Corridor South",
          active: false,
        },
        SIREN_OF26_003: {
          id: "SIREN_OF26_003",
          location: "Office Floor 26 Corridor East",
          active: false,
        },
        SIREN_OF26_004: {
          id: "SIREN_OF26_004",
          location: "Office Floor 26 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_26_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 26 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_26/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 26");
...
// Start the Office Floor 26 Actuator Controller
const controller = new OfficeFloor26ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 26 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor26ActuatorController;
