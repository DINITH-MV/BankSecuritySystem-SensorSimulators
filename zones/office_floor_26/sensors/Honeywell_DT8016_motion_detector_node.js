...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF26_016",
    location: "Office Floor 26 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF26_017",
    location: "Office Floor 26 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 26..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 26 Honeywell Motion Detector Nodes..."
  );
