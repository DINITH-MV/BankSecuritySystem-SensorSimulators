...
const CARD_READER_CONFIGS = [
  { readerId: "ACCESS_OF26_001", location: "Office Floor 26 Main Entrance" },
  {
    readerId: "ACCESS_OF26_002",
    location: "Office Floor 26 Secure Access Point",
  },
];
...
console.log(
  "Starting HID ProxPoint Card Reader monitoring for Office Floor 26..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 26 Card Reader Nodes...");
