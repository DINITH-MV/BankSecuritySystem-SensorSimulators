...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF26_001", location: "Office Floor 26 Main Entrance" },
  { sensorId: "CAM_OF26_002", location: "Office Floor 26 Reception Area" },
  { sensorId: "CAM_OF26_003", location: "Office Floor 26 Open Office Area A" },
  { sensorId: "CAM_OF26_004", location: "Office Floor 26 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 26 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 26 Camera Nodes...");
