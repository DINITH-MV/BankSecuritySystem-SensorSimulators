...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF29_016",
    location: "Office Floor 29 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF29_017",
    location: "Office Floor 29 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 29..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 29 Honeywell Motion Detector Nodes..."
  );
