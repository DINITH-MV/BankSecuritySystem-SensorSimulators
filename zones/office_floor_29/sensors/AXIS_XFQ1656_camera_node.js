...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF29_001", location: "Office Floor 29 Main Entrance" },
  { sensorId: "CAM_OF29_002", location: "Office Floor 29 Reception Area" },
  { sensorId: "CAM_OF29_003", location: "Office Floor 29 Open Office Area A" },
  { sensorId: "CAM_OF29_004", location: "Office Floor 29 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 29 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 29 Camera Nodes...");
