...
/**
 * Werma D62 LED Beacon - Office Floor 29
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF29_001", location: "Office Floor 29 Corridor North" },
  { beaconId: "BEACON_OF29_002", location: "Office Floor 29 Corridor South" },
  { beaconId: "BEACON_OF29_003", location: "Office Floor 29 Corridor East" },
  { beaconId: "BEACON_OF29_004", location: "Office Floor 29 Corridor West" },
];

const serverUrl = "http://localhost:3030";

class OfficeFloor29BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 29 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 29 Beacon System
const beaconSystem = new OfficeFloor29BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 29 Beacon System...");
