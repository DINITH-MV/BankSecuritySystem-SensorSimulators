...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 29 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF29_001", location: "Office Floor 29 Corridor North" },
  { sirenId: "SIREN_OF29_002", location: "Office Floor 29 Corridor South" },
  { sirenId: "SIREN_OF29_003", location: "Office Floor 29 Corridor East" },
  { sirenId: "SIREN_OF29_004", location: "Office Floor 29 Corridor West" },
];

const serverUrl = "http://localhost:3030";

class OfficeFloor29SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 29 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3030");
      } else {
...
// Start the Office Floor 29 Siren System
const sirenSystem = new OfficeFloor29SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 29 Siren System...");
