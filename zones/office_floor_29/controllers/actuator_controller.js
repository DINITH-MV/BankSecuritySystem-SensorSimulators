...
class OfficeFloor29ActuatorController {
  constructor() {
    this.zone = "office_floor_29";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF29_001: {
          id: "SIREN_OF29_001",
          location: "Office Floor 29 Corridor North",
          active: false,
        },
        SIREN_OF29_002: {
          id: "SIREN_OF29_002",
          location: "Office Floor 29 Corridor South",
          active: false,
        },
        SIREN_OF29_003: {
          id: "SIREN_OF29_003",
          location: "Office Floor 29 Corridor East",
          active: false,
        },
        SIREN_OF29_004: {
          id: "SIREN_OF29_004",
          location: "Office Floor 29 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_29_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 29 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_29/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 29");
...
// Start the Office Floor 29 Actuator Controller
const controller = new OfficeFloor29ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 29 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor29ActuatorController;
