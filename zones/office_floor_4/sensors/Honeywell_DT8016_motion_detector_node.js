...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF4_016",
    location: "Office Floor 4 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF4_017",
    location: "Office Floor 4 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 4..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 4 Honeywell Motion Detector Nodes..."
  );
