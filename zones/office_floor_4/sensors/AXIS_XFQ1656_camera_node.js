...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF4_001", location: "Office Floor 4 Main Entrance" },
  { sensorId: "CAM_OF4_002", location: "Office Floor 4 Reception Area" },
  { sensorId: "CAM_OF4_003", location: "Office Floor 4 Open Office Area A" },
  { sensorId: "CAM_OF4_004", location: "Office Floor 4 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 4 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 4 Camera Nodes...");
