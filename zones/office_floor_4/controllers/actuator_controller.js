...
class OfficeFloor4ActuatorController {
  constructor() {
    this.zone = "office_floor_4";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF4_001: {
          id: "SIREN_OF4_001",
          location: "Office Floor 4 Corridor North",
          active: false,
        },
        SIREN_OF4_002: {
          id: "SIREN_OF4_002",
          location: "Office Floor 4 Corridor South",
          active: false,
        },
        SIREN_OF4_003: {
          id: "SIREN_OF4_003",
          location: "Office Floor 4 Corridor East",
          active: false,
        },
        SIREN_OF4_004: {
          id: "SIREN_OF4_004",
          location: "Office Floor 4 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_4_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 4 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_4/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 4");
...
// Start the Office Floor 4 Actuator Controller
const controller = new OfficeFloor4ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 4 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor4ActuatorController;
