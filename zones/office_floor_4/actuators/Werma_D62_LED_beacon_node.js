...
/**
 * Werma D62 LED Beacon - Office Floor 4
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF4_001", location: "Office Floor 4 Corridor North" },
  { beaconId: "BEACON_OF4_002", location: "Office Floor 4 Corridor South" },
  { beaconId: "BEACON_OF4_003", location: "Office Floor 4 Corridor East" },
  { beaconId: "BEACON_OF4_004", location: "Office Floor 4 Corridor West" },
];

const serverUrl = "http://localhost:3005";

class OfficeFloor4BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 4 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 4 Beacon System
const beaconSystem = new OfficeFloor4BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 4 Beacon System...");
