...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 4 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF4_001", location: "Office Floor 4 Corridor North" },
  { sirenId: "SIREN_OF4_002", location: "Office Floor 4 Corridor South" },
  { sirenId: "SIREN_OF4_003", location: "Office Floor 4 Corridor East" },
  { sirenId: "SIREN_OF4_004", location: "Office Floor 4 Corridor West" },
];

const serverUrl = "http://localhost:3005";

class OfficeFloor4SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 4 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3005");
      } else {
...
// Start the Office Floor 4 Siren System
const sirenSystem = new OfficeFloor4SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 4 Siren System...");
