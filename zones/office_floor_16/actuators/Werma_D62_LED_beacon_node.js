...
/**
 * Werma D62 LED Beacon - Office Floor 16
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF16_001", location: "Office Floor 16 Corridor North" },
  { beaconId: "BEACON_OF16_002", location: "Office Floor 16 Corridor South" },
  { beaconId: "BEACON_OF16_003", location: "Office Floor 16 Corridor East" },
  { beaconId: "BEACON_OF16_004", location: "Office Floor 16 Corridor West" },
];

const serverUrl = "http://localhost:3017";

class OfficeFloor16BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 16 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 16 Beacon System
const beaconSystem = new OfficeFloor16BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 16 Beacon System...");
