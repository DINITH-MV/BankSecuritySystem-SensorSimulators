...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 16 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF16_001", location: "Office Floor 16 Corridor North" },
  { sirenId: "SIREN_OF16_002", location: "Office Floor 16 Corridor South" },
  { sirenId: "SIREN_OF16_003", location: "Office Floor 16 Corridor East" },
  { sirenId: "SIREN_OF16_004", location: "Office Floor 16 Corridor West" },
];

const serverUrl = "http://localhost:3017";

class OfficeFloor16SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 16 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3017");
      } else {
...
// Start the Office Floor 16 Siren System
const sirenSystem = new OfficeFloor16SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 16 Siren System...");
