...
class OfficeFloor16ActuatorController {
  constructor() {
    this.zone = "office_floor_16";
    this.serverUrl = "http://localhost:3017";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF16_001: {
          id: "SIREN_OF16_001",
          location: "Office Floor 16 Corridor North",
          active: false,
        },
        SIREN_OF16_002: {
          id: "SIREN_OF16_002",
          location: "Office Floor 16 Corridor South",
          active: false,
        },
        SIREN_OF16_003: {
          id: "SIREN_OF16_003",
          location: "Office Floor 16 Corridor East",
          active: false,
        },
        SIREN_OF16_004: {
          id: "SIREN_OF16_004",
          location: "Office Floor 16 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_16_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 16 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_16/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 16");
...
// Start the Office Floor 16 Actuator Controller
const controller = new OfficeFloor16ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 16 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor16ActuatorController;
