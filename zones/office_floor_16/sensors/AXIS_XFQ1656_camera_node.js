...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF16_001", location: "Office Floor 16 Main Entrance" },
  { sensorId: "CAM_OF16_002", location: "Office Floor 16 Reception Area" },
  { sensorId: "CAM_OF16_003", location: "Office Floor 16 Open Office Area A" },
  { sensorId: "CAM_OF16_004", location: "Office Floor 16 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 16 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 16 Camera Nodes...");
