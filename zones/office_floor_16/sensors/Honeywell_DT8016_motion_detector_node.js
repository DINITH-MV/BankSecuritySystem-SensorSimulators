...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF16_016",
    location: "Office Floor 16 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF16_017",
    location: "Office Floor 16 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 16..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 16 Honeywell Motion Detector Nodes..."
  );
