...
class OfficeFloor2ActuatorController {
  constructor() {
    this.zone = "office_floor_2";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF2_001: {
          id: "SIREN_OF2_001",
          location: "Office Floor 2 Corridor North",
          active: false,
        },
        SIREN_OF2_002: {
          id: "SIREN_OF2_002",
          location: "Office Floor 2 Corridor South",
          active: false,
        },
        SIREN_OF2_003: {
          id: "SIREN_OF2_003",
          location: "Office Floor 2 Corridor East",
          active: false,
        },
        SIREN_OF2_004: {
          id: "SIREN_OF2_004",
          location: "Office Floor 2 Corridor West",
          active: false,
        },
      },
      beacons: {
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 2 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_2/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in office floor 2");
...
// Start the Office Floor 2 Actuator Controller
const controller = new OfficeFloor2ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 2 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor2ActuatorController;
