...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF2_016",
    location: "Office Floor 2 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF2_017",
    location: "Office Floor 2 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for office floor 2..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 2 Honeywell Motion Detector Nodes..."
  );
