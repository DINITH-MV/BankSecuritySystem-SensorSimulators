...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF2_001", location: "Office Floor 2 Main Entrance" },
  { sensorId: "CAM_OF2_002", location: "Office Floor 2 Reception Area" },
  { sensorId: "CAM_OF2_003", location: "Office Floor 2 Open Office Area A" },
  { sensorId: "CAM_OF2_004", location: "Office Floor 2 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for office floor 2 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 2 Camera Nodes...");
