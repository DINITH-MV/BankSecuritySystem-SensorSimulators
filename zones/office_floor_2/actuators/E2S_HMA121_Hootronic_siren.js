...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 2 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF2_001", location: "Office Floor 2 Corridor North" },
  { sirenId: "SIREN_OF2_002", location: "Office Floor 2 Corridor South" },
  { sirenId: "SIREN_OF2_003", location: "Office Floor 2 Corridor East" },
  { sirenId: "SIREN_OF2_004", location: "Office Floor 2 Corridor West" },
];

const serverUrl = "http://localhost:3003";

class OfficeFloor2SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 2 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3003");
      } else {
...
// Start the Office Floor 2 Siren System
const sirenSystem = new OfficeFloor2SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 2 Siren System...");
