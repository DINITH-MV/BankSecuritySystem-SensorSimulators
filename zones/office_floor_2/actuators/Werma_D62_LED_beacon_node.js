...
/**
 * Werma D62 LED Beacon - Office Floor 2
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF2_001", location: "Office Floor 2 Corridor North" },
  { beaconId: "BEACON_OF2_002", location: "Office Floor 2 Corridor South" },
  { beaconId: "BEACON_OF2_003", location: "Office Floor 2 Corridor East" },
  { beaconId: "BEACON_OF2_004", location: "Office Floor 2 Corridor West" },
];

const serverUrl = "http://localhost:3003";

class OfficeFloor2BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 2 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 2 Beacon System
const beaconSystem = new OfficeFloor2BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 2 Beacon System...");
