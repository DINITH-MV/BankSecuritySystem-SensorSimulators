...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF27_016",
    location: "Office Floor 27 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF27_017",
    location: "Office Floor 27 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 27..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 27 Honeywell Motion Detector Nodes..."
  );
