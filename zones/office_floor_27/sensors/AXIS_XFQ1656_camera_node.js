...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF27_001", location: "Office Floor 27 Main Entrance" },
  { sensorId: "CAM_OF27_002", location: "Office Floor 27 Reception Area" },
  { sensorId: "CAM_OF27_003", location: "Office Floor 27 Open Office Area A" },
  { sensorId: "CAM_OF27_004", location: "Office Floor 27 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 27 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 27 Camera Nodes...");
