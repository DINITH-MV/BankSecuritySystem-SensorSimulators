...
class OfficeFloor27ActuatorController {
  constructor() {
    this.zone = "office_floor_27";
    this.serverUrl = "http://localhost:3028";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF27_001: {
          id: "SIREN_OF27_001",
          location: "Office Floor 27 Corridor North",
          active: false,
        },
        SIREN_OF27_002: {
          id: "SIREN_OF27_002",
          location: "Office Floor 27 Corridor South",
          active: false,
        },
        SIREN_OF27_003: {
          id: "SIREN_OF27_003",
          location: "Office Floor 27 Corridor East",
          active: false,
        },
        SIREN_OF27_004: {
          id: "SIREN_OF27_004",
          location: "Office Floor 27 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_27_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 27 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_27/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 27");
...
// Start the Office Floor 27 Actuator Controller
const controller = new OfficeFloor27ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 27 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor27ActuatorController;
