...
/**
 * Werma D62 LED Beacon - Office Floor 27
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF27_001", location: "Office Floor 27 Corridor North" },
  { beaconId: "BEACON_OF27_002", location: "Office Floor 27 Corridor South" },
  { beaconId: "BEACON_OF27_003", location: "Office Floor 27 Corridor East" },
  { beaconId: "BEACON_OF27_004", location: "Office Floor 27 Corridor West" },
];

const serverUrl = "http://localhost:3028";

class OfficeFloor27BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 27 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 27 Beacon System
const beaconSystem = new OfficeFloor27BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 27 Beacon System...");
