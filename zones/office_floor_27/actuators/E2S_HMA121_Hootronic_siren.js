...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 27 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF27_001", location: "Office Floor 27 Corridor North" },
  { sirenId: "SIREN_OF27_002", location: "Office Floor 27 Corridor South" },
  { sirenId: "SIREN_OF27_003", location: "Office Floor 27 Corridor East" },
  { sirenId: "SIREN_OF27_004", location: "Office Floor 27 Corridor West" },
];

const serverUrl = "http://localhost:3028";

class OfficeFloor27SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 27 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3028");
      } else {
...
// Start the Office Floor 27 Siren System
const sirenSystem = new OfficeFloor27SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 27 Siren System...");
