...
/**
 * Werma D62 LED Beacon - Office Floor 10
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF10_001", location: "Office Floor 10 Corridor North" },
  { beaconId: "BEACON_OF10_002", location: "Office Floor 10 Corridor South" },
  { beaconId: "BEACON_OF10_003", location: "Office Floor 10 Corridor East" },
  { beaconId: "BEACON_OF10_004", location: "Office Floor 10 Corridor West" },
];

const serverUrl = "http://localhost:3011";

class OfficeFloor10BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 10 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 10 Beacon System
const beaconSystem = new OfficeFloor10BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 10 Beacon System...");
