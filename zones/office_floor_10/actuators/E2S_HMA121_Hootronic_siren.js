...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 10 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF10_001", location: "Office Floor 10 Corridor North" },
  { sirenId: "SIREN_OF10_002", location: "Office Floor 10 Corridor South" },
  { sirenId: "SIREN_OF10_003", location: "Office Floor 10 Corridor East" },
  { sirenId: "SIREN_OF10_004", location: "Office Floor 10 Corridor West" },
];

const serverUrl = "http://localhost:3011";

class OfficeFloor10SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 10 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3011");
      } else {
...
// Start the Office Floor 10 Siren System
const sirenSystem = new OfficeFloor10SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 10 Siren System...");
