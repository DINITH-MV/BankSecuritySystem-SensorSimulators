...
class OfficeFloor10ActuatorController {
  constructor() {
    this.zone = "office_floor_10";
    this.serverUrl = "http://localhost:3011";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF10_001: {
          id: "SIREN_OF10_001",
          location: "Office Floor 10 Corridor North",
          active: false,
        },
        SIREN_OF10_002: {
          id: "SIREN_OF10_002",
          location: "Office Floor 10 Corridor South",
          active: false,
        },
        SIREN_OF10_003: {
          id: "SIREN_OF10_003",
          location: "Office Floor 10 Corridor East",
          active: false,
        },
        SIREN_OF10_004: {
          id: "SIREN_OF10_004",
          location: "Office Floor 10 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_10_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 10 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_10/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 10");
...
// Start the Office Floor 10 Actuator Controller
const controller = new OfficeFloor10ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 10 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor10ActuatorController;
