...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF10_016",
    location: "Office Floor 10 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF10_017",
    location: "Office Floor 10 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 10..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 10 Honeywell Motion Detector Nodes..."
  );
