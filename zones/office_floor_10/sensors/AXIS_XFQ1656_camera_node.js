...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF10_001", location: "Office Floor 10 Main Entrance" },
  { sensorId: "CAM_OF10_002", location: "Office Floor 10 Reception Area" },
  { sensorId: "CAM_OF10_003", location: "Office Floor 10 Open Office Area A" },
  { sensorId: "CAM_OF10_004", location: "Office Floor 10 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 10 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 10 Camera Nodes...");
