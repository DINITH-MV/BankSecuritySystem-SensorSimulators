...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 30 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF30_001", location: "Office Floor 30 Corridor North" },
  { sirenId: "SIREN_OF30_002", location: "Office Floor 30 Corridor South" },
  { sirenId: "SIREN_OF30_003", location: "Office Floor 30 Corridor East" },
  { sirenId: "SIREN_OF30_004", location: "Office Floor 30 Corridor West" },
];

const serverUrl = "http://localhost:3031";

class OfficeFloor30SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 30 Siren System initialized with web server control"
    );
...
// Start the Office Floor 30 Siren System
const sirenSystem = new OfficeFloor30SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 30 Siren System...");
