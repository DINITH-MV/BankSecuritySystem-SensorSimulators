...
/**
 * Werma D62 LED Beacon - Office Floor 30
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF30_001", location: "Office Floor 30 Corridor North" },
  { beaconId: "BEACON_OF30_002", location: "Office Floor 30 Corridor South" },
  { beaconId: "BEACON_OF30_003", location: "Office Floor 30 Corridor East" },
  { beaconId: "BEACON_OF30_004", location: "Office Floor 30 Corridor West" },
];

const serverUrl = "http://localhost:3031";

class OfficeFloor30BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 30 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 30 Beacon System
const beaconSystem = new OfficeFloor30BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 30 Beacon System...");
