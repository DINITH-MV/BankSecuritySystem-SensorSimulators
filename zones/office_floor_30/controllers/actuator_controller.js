...
class OfficeFloor30ActuatorController {
  constructor() {
    ...
    this.actuators = {
      sirens: {
        SIREN_OF30_001: {
          id: "SIREN_OF30_001",
          location: "Office Floor 30 Corridor North",
          active: false,
        },
        SIREN_OF30_002: {
          id: "SIREN_OF30_002",
          location: "Office Floor 30 Corridor South",
          active: false,
        },
        SIREN_OF30_003: {
          id: "SIREN_OF30_003",
          location: "Office Floor 30 Corridor East",
          active: false,
        },
        SIREN_OF30_004: {
          id: "SIREN_OF30_004",
          location: "Office Floor 30 Corridor West",
          active: false,
        },
      },
      beacons: {
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 30 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_30/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 30");
...
// Start the Office Floor 30 Actuator Controller
const controller = new OfficeFloor30ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 30 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor30ActuatorController;
