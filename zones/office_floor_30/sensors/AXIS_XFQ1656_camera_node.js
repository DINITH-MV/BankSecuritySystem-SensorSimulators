...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF30_001", location: "Office Floor 30 Main Entrance" },
  { sensorId: "CAM_OF30_002", location: "Office Floor 30 Reception Area" },
  { sensorId: "CAM_OF30_003", location: "Office Floor 30 Open Office Area A" },
  { sensorId: "CAM_OF30_004", location: "Office Floor 30 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 30 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 30 Camera Nodes...");
