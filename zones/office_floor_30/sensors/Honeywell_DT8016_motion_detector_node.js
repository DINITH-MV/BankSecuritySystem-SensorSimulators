...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF30_016",
    location: "Office Floor 30 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF30_017",
    location: "Office Floor 30 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 30..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 30 Honeywell Motion Detector Nodes..."
  );
