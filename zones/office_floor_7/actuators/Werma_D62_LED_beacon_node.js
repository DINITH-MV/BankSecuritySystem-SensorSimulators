...
/**
 * Werma D62 LED Beacon - Office Floor 7
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF7_001", location: "Office Floor 7 Corridor North" },
  { beaconId: "BEACON_OF7_002", location: "Office Floor 7 Corridor South" },
  { beaconId: "BEACON_OF7_003", location: "Office Floor 7 Corridor East" },
  { beaconId: "BEACON_OF7_004", location: "Office Floor 7 Corridor West" },
];

const serverUrl = "http://localhost:3008";

class OfficeFloor7BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 7 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 7 Beacon System
const beaconSystem = new OfficeFloor7BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 7 Beacon System...");
