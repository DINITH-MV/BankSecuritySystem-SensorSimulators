...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 7 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF7_001", location: "Office Floor 7 Corridor North" },
  { sirenId: "SIREN_OF7_002", location: "Office Floor 7 Corridor South" },
  { sirenId: "SIREN_OF7_003", location: "Office Floor 7 Corridor East" },
  { sirenId: "SIREN_OF7_004", location: "Office Floor 7 Corridor West" },
];

const serverUrl = "http://localhost:3008";

class OfficeFloor7SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 7 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3008");
      } else {
...
// Start the Office Floor 7 Siren System
const sirenSystem = new OfficeFloor7SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 7 Siren System...");
