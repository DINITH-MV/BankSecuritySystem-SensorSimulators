...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF7_016",
    location: "Office Floor 7 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF7_017",
    location: "Office Floor 7 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 7..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 7 Honeywell Motion Detector Nodes..."
  );
