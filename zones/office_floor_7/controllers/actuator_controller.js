...
class OfficeFloor7ActuatorController {
  constructor() {
    this.zone = "office_floor_7";
    this.serverUrl = "http://localhost:3008";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF7_001: {
          id: "SIREN_OF7_001",
          location: "Office Floor 7 Corridor North",
          active: false,
        },
        SIREN_OF7_002: {
          id: "SIREN_OF7_002",
          location: "Office Floor 7 Corridor South",
          active: false,
        },
        SIREN_OF7_003: {
          id: "SIREN_OF7_003",
          location: "Office Floor 7 Corridor East",
          active: false,
        },
        SIREN_OF7_004: {
          id: "SIREN_OF7_004",
          location: "Office Floor 7 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_7_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 7 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_7/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 7");
...
// Start the Office Floor 7 Actuator Controller
const controller = new OfficeFloor7ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 7 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor7ActuatorController;
