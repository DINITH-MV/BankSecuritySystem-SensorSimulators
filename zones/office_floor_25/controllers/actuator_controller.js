...
class OfficeFloor25ActuatorController {
  constructor() {
    this.zone = "office_floor_25";
    this.serverUrl = "http://localhost:3026";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF25_001: {
          id: "SIREN_OF25_001",
          location: "Office Floor 25 Corridor North",
          active: false,
        },
        SIREN_OF25_002: {
          id: "SIREN_OF25_002",
          location: "Office Floor 25 Corridor South",
          active: false,
        },
        SIREN_OF25_003: {
          id: "SIREN_OF25_003",
          location: "Office Floor 25 Corridor East",
          active: false,
        },
        SIREN_OF25_004: {
          id: "SIREN_OF25_004",
          location: "Office Floor 25 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_25_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 25 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_25/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 25");
...
// Start the Office Floor 25 Actuator Controller
const controller = new OfficeFloor25ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 25 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor25ActuatorController;
