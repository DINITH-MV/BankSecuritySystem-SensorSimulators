...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 25 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF25_001", location: "Office Floor 25 Corridor North" },
  { sirenId: "SIREN_OF25_002", location: "Office Floor 25 Corridor South" },
  { sirenId: "SIREN_OF25_003", location: "Office Floor 25 Corridor East" },
  { sirenId: "SIREN_OF25_004", location: "Office Floor 25 Corridor West" },
];

const serverUrl = "http://localhost:3026";

class OfficeFloor25SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 25 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3026");
      } else {
...
// Start the Office Floor 25 Siren System
const sirenSystem = new OfficeFloor25SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 25 Siren System...");
