...
/**
 * Werma D62 LED Beacon - Office Floor 25
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF25_001", location: "Office Floor 25 Corridor North" },
  { beaconId: "BEACON_OF25_002", location: "Office Floor 25 Corridor South" },
  { beaconId: "BEACON_OF25_003", location: "Office Floor 25 Corridor East" },
  { beaconId: "BEACON_OF25_004", location: "Office Floor 25 Corridor West" },
];

const serverUrl = "http://localhost:3026";

class OfficeFloor25BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 25 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 25 Beacon System
const beaconSystem = new OfficeFloor25BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 25 Beacon System...");
