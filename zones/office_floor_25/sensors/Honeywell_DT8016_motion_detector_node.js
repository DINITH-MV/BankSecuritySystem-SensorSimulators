...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF25_016",
    location: "Office Floor 25 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF25_017",
    location: "Office Floor 25 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 25..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 25 Honeywell Motion Detector Nodes..."
  );
