...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF25_001", location: "Office Floor 25 Main Entrance" },
  { sensorId: "CAM_OF25_002", location: "Office Floor 25 Reception Area" },
  { sensorId: "CAM_OF25_003", location: "Office Floor 25 Open Office Area A" },
  { sensorId: "CAM_OF25_004", location: "Office Floor 25 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 25 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 25 Camera Nodes...");
