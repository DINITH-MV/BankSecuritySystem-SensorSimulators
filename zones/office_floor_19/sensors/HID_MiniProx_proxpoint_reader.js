...
const CARD_READER_CONFIGS = [
  { readerId: "ACCESS_OF3_001", location: "Office Floor 19 Main Entrance" },
  {
    readerId: "ACCESS_OF3_002",
    location: "Office Floor 19 Secure Access Point",
  },
];
...
console.log(
  "Starting HID ProxPoint Card Reader monitoring for Office Floor 19..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 19 Card Reader Nodes...");
