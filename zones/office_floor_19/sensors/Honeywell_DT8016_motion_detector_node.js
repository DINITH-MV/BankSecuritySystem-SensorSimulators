...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF3_016",
    location: "Office Floor 19 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF3_017",
    location: "Office Floor 19 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 19..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 19 Honeywell Motion Detector Nodes..."
  );
