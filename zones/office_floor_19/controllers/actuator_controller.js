...
class OfficeFloor19ActuatorController {
  constructor() {
    this.zone = "office_floor_3";
    this.serverUrl = "http://localhost:3020";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF3_001: {
          id: "SIREN_OF3_001",
          location: "Office Floor 19 Corridor North",
          active: false,
        },
        SIREN_OF3_002: {
          id: "SIREN_OF3_002",
          location: "Office Floor 19 Corridor South",
          active: false,
        },
        SIREN_OF3_003: {
          id: "SIREN_OF3_003",
          location: "Office Floor 19 Corridor East",
          active: false,
        },
        SIREN_OF3_004: {
          id: "SIREN_OF3_004",
          location: "Office Floor 19 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_3_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 19 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_3/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 19");
...
// Start the Office Floor 19 Actuator Controller
const controller = new OfficeFloor19ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 19 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor19ActuatorController;
