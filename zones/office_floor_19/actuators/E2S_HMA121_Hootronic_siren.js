...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 19 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF3_001", location: "Office Floor 19 Corridor North" },
  { sirenId: "SIREN_OF3_002", location: "Office Floor 19 Corridor South" },
  { sirenId: "SIREN_OF3_003", location: "Office Floor 19 Corridor East" },
  { sirenId: "SIREN_OF3_004", location: "Office Floor 19 Corridor West" },
];

const serverUrl = "http://localhost:3020";

class OfficeFloor19SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 19 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3020");
      } else {
...
// Start the Office Floor 19 Siren System
const sirenSystem = new OfficeFloor19SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 19 Siren System...");
