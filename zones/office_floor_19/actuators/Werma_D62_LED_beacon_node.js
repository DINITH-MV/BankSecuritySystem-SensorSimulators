...
/**
 * Werma D62 LED Beacon - Office Floor 19
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF3_001", location: "Office Floor 19 Corridor North" },
  { beaconId: "BEACON_OF3_002", location: "Office Floor 19 Corridor South" },
  { beaconId: "BEACON_OF3_003", location: "Office Floor 19 Corridor East" },
  { beaconId: "BEACON_OF3_004", location: "Office Floor 19 Corridor West" },
];

const serverUrl = "http://localhost:3020";

class OfficeFloor19BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 19 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 19 Beacon System
const beaconSystem = new OfficeFloor19BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 19 Beacon System...");
