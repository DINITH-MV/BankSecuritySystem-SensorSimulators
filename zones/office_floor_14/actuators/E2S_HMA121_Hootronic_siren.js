...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 14 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF14_001", location: "Office Floor 14 Corridor North" },
  { sirenId: "SIREN_OF14_002", location: "Office Floor 14 Corridor South" },
  { sirenId: "SIREN_OF14_003", location: "Office Floor 14 Corridor East" },
  { sirenId: "SIREN_OF14_004", location: "Office Floor 14 Corridor West" },
];

const serverUrl = "http://localhost:3015";

class OfficeFloor14SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 14 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3015");
      } else {
...
// Start the Office Floor 14 Siren System
const sirenSystem = new OfficeFloor14SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 14 Siren System...");
