...
/**
 * Werma D62 LED Beacon - Office Floor 14
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF14_001", location: "Office Floor 14 Corridor North" },
  { beaconId: "BEACON_OF14_002", location: "Office Floor 14 Corridor South" },
  { beaconId: "BEACON_OF14_003", location: "Office Floor 14 Corridor East" },
  { beaconId: "BEACON_OF14_004", location: "Office Floor 14 Corridor West" },
];

const serverUrl = "http://localhost:3015";

class OfficeFloor14BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 14 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 14 Beacon System
const beaconSystem = new OfficeFloor14BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 14 Beacon System...");
