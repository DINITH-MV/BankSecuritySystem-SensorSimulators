...
const HONEYWELL_CONFIGS = [
  {
    sensorId: "HONEY_OF14_001",
    location: "Office Floor 14 Reception Area",
  },
  {
    sensorId: "HONEY_OF14_002",
    location: "Office Floor 14 Executive Office Entrance",
  },
];
...
function startHoneywellSensors() {
  console.log("Starting Office Floor 14 Honeywell DT8016 Motion Detectors...");
  ...
  console.log("All Office Floor 14 Honeywell sensors started");
}

startHoneywellSensors();

process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 14 Honeywell sensors...");
  process.exit(0);
});
