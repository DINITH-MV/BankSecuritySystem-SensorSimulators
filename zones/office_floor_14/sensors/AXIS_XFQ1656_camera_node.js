...
const CAMERA_CONFIGS = [
  {
    cameraId: "CAM_OF14_001",
    location: "Office Floor 14 Open Office Area A - Northeast Corner",
  },
  {
    cameraId: "CAM_OF14_002",
    location: "Office Floor 14 Open Office Area B - Southeast Corner",
  },
  {
    cameraId: "CAM_OF14_003",
    location: "Office Floor 14 Meeting Room A - Ceiling Mount",
  },
  {
    cameraId: "CAM_OF14_004",
    location: "Office Floor 14 Corridor - Central Junction",
  },
];
...
function startCameraSensors() {
  console.log("Starting Office Floor 14 AXIS XFQ1656 Security Cameras...");
  ...
  console.log("All Office Floor 14 security cameras started");
}

startCameraSensors();

process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 14 security cameras...");
  process.exit(0);
});
