...
const CARD_READER_CONFIGS = [
  {
    readerId: "CARD_OF14_001",
    location: "Office Floor 14 Main Entrance",
  },
  {
    readerId: "CARD_OF14_002",
    location: "Office Floor 14 Conference Room Entrance",
  },
];
...
function generateCardReaderData(config) {
  ...
  const sensorData = {
    ...
    data: {
      ...
      accessLevel: accessGranted ? "OFFICE_FLOOR_14" : null,
...
function startCardReaders() {
  console.log("Starting Office Floor 14 HID ProxPoint Plus Card Readers...");
  ...
  console.log("All Office Floor 14 card readers started");
}

startCardReaders();

process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 14 card readers...");
  process.exit(0);
});
