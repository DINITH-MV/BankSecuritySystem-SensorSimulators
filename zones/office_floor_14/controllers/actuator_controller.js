...
class OfficeFloor14ActuatorController {
  constructor() {
    this.zone = "office_floor_14";
    this.serverUrl = "http://localhost:3015";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF14_001: {
          id: "SIREN_OF14_001",
          location: "Office Floor 14 Corridor North",
          active: false,
        },
        SIREN_OF14_002: {
          id: "SIREN_OF14_002",
          location: "Office Floor 14 Corridor South",
          active: false,
        },
        SIREN_OF14_003: {
          id: "SIREN_OF14_003",
          location: "Office Floor 14 Corridor East",
          active: false,
        },
        SIREN_OF14_004: {
          id: "SIREN_OF14_004",
          location: "Office Floor 14 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_14_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 14 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_14/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 14");
...
// Start the Office Floor 14 Actuator Controller
const controller = new OfficeFloor14ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 14 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor14ActuatorController;
