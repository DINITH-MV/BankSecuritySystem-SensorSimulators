...
class OfficeFloor14SensorController {
  constructor() {
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 14 Sensor Controller connected to MQTT");
  ...
  triggerAlert(sensorId, alert) {
    ...
    console.log(
      `Office Floor 14 ALERT TRIGGERED: ${alert.type} - ${alert.severity}`
    );
...
// Start the Office Floor 14 Sensor Controller
const controller = new OfficeFloor14SensorController();
...
export default OfficeFloor14SensorController;
