...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF8_001", location: "Office Floor 8 Main Entrance" },
  { sensorId: "CAM_OF8_002", location: "Office Floor 8 Reception Area" },
  { sensorId: "CAM_OF8_003", location: "Office Floor 8 Open Office Area A" },
  { sensorId: "CAM_OF8_004", location: "Office Floor 8 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 8 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 8 Camera Nodes...");
