...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF8_016",
    location: "Office Floor 8 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF8_017",
    location: "Office Floor 8 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 8..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 8 Honeywell Motion Detector Nodes..."
  );
