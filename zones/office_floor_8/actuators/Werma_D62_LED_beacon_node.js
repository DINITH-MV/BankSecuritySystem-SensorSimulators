...
/**
 * Werma D62 LED Beacon - Office Floor 8
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF8_001", location: "Office Floor 8 Corridor North" },
  { beaconId: "BEACON_OF8_002", location: "Office Floor 8 Corridor South" },
  { beaconId: "BEACON_OF8_003", location: "Office Floor 8 Corridor East" },
  { beaconId: "BEACON_OF8_004", location: "Office Floor 8 Corridor West" },
];

const serverUrl = "http://localhost:3009";

class OfficeFloor8BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 8 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 8 Beacon System
const beaconSystem = new OfficeFloor8BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 8 Beacon System...");
