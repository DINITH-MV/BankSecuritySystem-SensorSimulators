...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 8 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF8_001", location: "Office Floor 8 Corridor North" },
  { sirenId: "SIREN_OF8_002", location: "Office Floor 8 Corridor South" },
  { sirenId: "SIREN_OF8_003", location: "Office Floor 8 Corridor East" },
  { sirenId: "SIREN_OF8_004", location: "Office Floor 8 Corridor West" },
];

const serverUrl = "http://localhost:3009";

class OfficeFloor8SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 8 Siren System initialized with web server control"
    );
...
// Start the Office Floor 8 Siren System
const sirenSystem = new OfficeFloor8SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 8 Siren System...");
