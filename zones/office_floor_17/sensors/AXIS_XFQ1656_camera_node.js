...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF17_001", location: "Office Floor 17 Main Entrance" },
  { sensorId: "CAM_OF17_002", location: "Office Floor 17 Reception Area" },
  { sensorId: "CAM_OF17_003", location: "Office Floor 17 Open Office Area A" },
  { sensorId: "CAM_OF17_004", location: "Office Floor 17 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 17 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 17 Camera Nodes...");
