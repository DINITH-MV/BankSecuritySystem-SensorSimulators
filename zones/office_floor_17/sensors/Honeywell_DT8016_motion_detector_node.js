...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF17_016",
    location: "Office Floor 17 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF17_017",
    location: "Office Floor 17 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 17..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 17 Honeywell Motion Detector Nodes..."
  );
