...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 17 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF17_001", location: "Office Floor 17 Corridor North" },
  { sirenId: "SIREN_OF17_002", location: "Office Floor 17 Corridor South" },
  { sirenId: "SIREN_OF17_003", location: "Office Floor 17 Corridor East" },
  { sirenId: "SIREN_OF17_004", location: "Office Floor 17 Corridor West" },
];

const serverUrl = "http://localhost:3018";

class OfficeFloor17SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 17 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3018");
      } else {
...
// Start the Office Floor 17 Siren System
const sirenSystem = new OfficeFloor17SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 17 Siren System...");
