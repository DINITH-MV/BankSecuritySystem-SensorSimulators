...
/**
 * Werma D62 LED Beacon - Office Floor 17
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF17_001", location: "Office Floor 17 Corridor North" },
  { beaconId: "BEACON_OF17_002", location: "Office Floor 17 Corridor South" },
  { beaconId: "BEACON_OF17_003", location: "Office Floor 17 Corridor East" },
  { beaconId: "BEACON_OF17_004", location: "Office Floor 17 Corridor West" },
];

const serverUrl = "http://localhost:3018";

class OfficeFloor17BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 17 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 17 Beacon System
const beaconSystem = new OfficeFloor17BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 17 Beacon System...");
