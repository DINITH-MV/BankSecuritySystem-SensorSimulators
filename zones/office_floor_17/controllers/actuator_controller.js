...
class OfficeFloor17ActuatorController {
  constructor() {
    this.zone = "office_floor_17";
    this.serverUrl = "http://localhost:3018";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF17_001: {
          id: "SIREN_OF17_001",
          location: "Office Floor 17 Corridor North",
          active: false,
        },
        SIREN_OF17_002: {
          id: "SIREN_OF17_002",
          location: "Office Floor 17 Corridor South",
          active: false,
        },
        SIREN_OF17_003: {
          id: "SIREN_OF17_003",
          location: "Office Floor 17 Corridor East",
          active: false,
        },
        SIREN_OF17_004: {
          id: "SIREN_OF17_004",
          location: "Office Floor 17 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_17_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 17 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_17/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 17");
...
// Start the Office Floor 17 Actuator Controller
const controller = new OfficeFloor17ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 17 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor17ActuatorController;
