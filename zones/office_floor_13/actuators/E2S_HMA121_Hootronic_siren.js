...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 13 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF13_001", location: "Office Floor 13 Corridor North" },
  { sirenId: "SIREN_OF13_002", location: "Office Floor 13 Corridor South" },
  { sirenId: "SIREN_OF13_003", location: "Office Floor 13 Corridor East" },
  { sirenId: "SIREN_OF13_004", location: "Office Floor 13 Corridor West" },
];

const serverUrl = "http://localhost:3014";

class OfficeFloor13SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 13 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3014");
      } else {
...
// Start the Office Floor 13 Siren System
const sirenSystem = new OfficeFloor13SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 13 Siren System...");
