...
/**
 * Werma D62 LED Beacon - Office Floor 13
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF13_001", location: "Office Floor 13 Corridor North" },
  { beaconId: "BEACON_OF13_002", location: "Office Floor 13 Corridor South" },
  { beaconId: "BEACON_OF13_003", location: "Office Floor 13 Corridor East" },
  { beaconId: "BEACON_OF13_004", location: "Office Floor 13 Corridor West" },
];

const serverUrl = "http://localhost:3014";

class OfficeFloor13BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 13 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 13 Beacon System
const beaconSystem = new OfficeFloor13BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 13 Beacon System...");
