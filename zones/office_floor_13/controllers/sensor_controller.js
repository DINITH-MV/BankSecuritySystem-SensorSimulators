...
class OfficeFloor13SensorController {
  constructor() {
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 13 Sensor Controller connected to MQTT");
  ...
  triggerAlert(sensorId, alert) {
    ...
    console.log(
      `Office Floor 13 ALERT TRIGGERED: ${alert.type} - ${alert.severity}`
    );
...
// Start the Office Floor 13 Sensor Controller
const controller = new OfficeFloor13SensorController();
...
export default OfficeFloor13SensorController;
