...
class OfficeFloor13ActuatorController {
  constructor() {
    this.zone = "office_floor_13";
    this.serverUrl = "http://localhost:3014";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF13_001: {
          id: "SIREN_OF13_001",
          location: "Office Floor 13 Corridor North",
          active: false,
        },
        SIREN_OF13_002: {
          id: "SIREN_OF13_002",
          location: "Office Floor 13 Corridor South",
          active: false,
        },
        SIREN_OF13_003: {
          id: "SIREN_OF13_003",
          location: "Office Floor 13 Corridor East",
          active: false,
        },
        SIREN_OF13_004: {
          id: "SIREN_OF13_004",
          location: "Office Floor 13 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_13_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 13 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_13/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 13");
...
// Start the Office Floor 13 Actuator Controller
const controller = new OfficeFloor13ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 13 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor13ActuatorController;
