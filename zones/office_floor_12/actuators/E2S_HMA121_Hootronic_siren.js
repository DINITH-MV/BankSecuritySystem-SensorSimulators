...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 12 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF12_001", location: "Office Floor 12 Corridor North" },
  { sirenId: "SIREN_OF12_002", location: "Office Floor 12 Corridor South" },
  { sirenId: "SIREN_OF12_003", location: "Office Floor 12 Corridor East" },
  { sirenId: "SIREN_OF12_004", location: "Office Floor 12 Corridor West" },
];

const serverUrl = "http://localhost:3013";

class OfficeFloor12SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 12 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3013");
      } else {
...
// Start the Office Floor 12 Siren System
const sirenSystem = new OfficeFloor12SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 12 Siren System...");
