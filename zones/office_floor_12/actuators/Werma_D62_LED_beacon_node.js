...
/**
 * Werma D62 LED Beacon - Office Floor 12
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF12_001", location: "Office Floor 12 Corridor North" },
  { beaconId: "BEACON_OF12_002", location: "Office Floor 12 Corridor South" },
  { beaconId: "BEACON_OF12_003", location: "Office Floor 12 Corridor East" },
  { beaconId: "BEACON_OF12_004", location: "Office Floor 12 Corridor West" },
];

const serverUrl = "http://localhost:3013";

class OfficeFloor12BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 12 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 12 Beacon System
const beaconSystem = new OfficeFloor12BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 12 Beacon System...");
