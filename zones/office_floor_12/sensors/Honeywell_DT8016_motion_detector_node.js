...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF12_016",
    location: "Office Floor 12 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF12_017",
    location: "Office Floor 12 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 12..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 12 Honeywell Motion Detector Nodes..."
  );
