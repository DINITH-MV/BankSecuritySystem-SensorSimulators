...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF12_001", location: "Office Floor 12 Main Entrance" },
  { sensorId: "CAM_OF12_002", location: "Office Floor 12 Reception Area" },
  { sensorId: "CAM_OF12_003", location: "Office Floor 12 Open Office Area A" },
  { sensorId: "CAM_OF12_004", location: "Office Floor 12 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 12 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 12 Camera Nodes...");
