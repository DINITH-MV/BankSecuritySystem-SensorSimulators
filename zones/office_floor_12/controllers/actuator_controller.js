...
class OfficeFloor12ActuatorController {
  constructor() {
    this.zone = "office_floor_12";
    this.serverUrl = "http://localhost:3013";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF12_001: {
          id: "SIREN_OF12_001",
          location: "Office Floor 12 Corridor North",
          active: false,
        },
        SIREN_OF12_002: {
          id: "SIREN_OF12_002",
          location: "Office Floor 12 Corridor South",
          active: false,
        },
        SIREN_OF12_003: {
          id: "SIREN_OF12_003",
          location: "Office Floor 12 Corridor East",
          active: false,
        },
        SIREN_OF12_004: {
          id: "SIREN_OF12_004",
          location: "Office Floor 12 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_12_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 12 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_12/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 12");
...
// Start the Office Floor 12 Actuator Controller
const controller = new OfficeFloor12ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 12 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor12ActuatorController;
