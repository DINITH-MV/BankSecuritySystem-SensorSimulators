...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF28_001", location: "Office Floor 28 Main Entrance" },
  { sensorId: "CAM_OF28_002", location: "Office Floor 28 Reception Area" },
  { sensorId: "CAM_OF28_003", location: "Office Floor 28 Open Office Area A" },
  { sensorId: "CAM_OF28_004", location: "Office Floor 28 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 28 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 28 Camera Nodes...");
