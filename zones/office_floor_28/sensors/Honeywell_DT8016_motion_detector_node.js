...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF28_016",
    location: "Office Floor 28 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF28_017",
    location: "Office Floor 28 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 28..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 28 Honeywell Motion Detector Nodes..."
  );
