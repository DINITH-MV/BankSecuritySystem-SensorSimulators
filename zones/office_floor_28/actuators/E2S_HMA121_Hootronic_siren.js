...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 28 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF28_001", location: "Office Floor 28 Corridor North" },
  { sirenId: "SIREN_OF28_002", location: "Office Floor 28 Corridor South" },
  { sirenId: "SIREN_OF28_003", location: "Office Floor 28 Corridor East" },
  { sirenId: "SIREN_OF28_004", location: "Office Floor 28 Corridor West" },
];

const serverUrl = "http://localhost:3029";

class OfficeFloor28SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 28 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3029");
      } else {
...
// Start the Office Floor 28 Siren System
const sirenSystem = new OfficeFloor28SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 28 Siren System...");
