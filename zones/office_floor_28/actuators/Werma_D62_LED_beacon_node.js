...
/**
 * Werma D62 LED Beacon - Office Floor 28
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF28_001", location: "Office Floor 28 Corridor North" },
  { beaconId: "BEACON_OF28_002", location: "Office Floor 28 Corridor South" },
  { beaconId: "BEACON_OF28_003", location: "Office Floor 28 Corridor East" },
  { beaconId: "BEACON_OF28_004", location: "Office Floor 28 Corridor West" },
];

const serverUrl = "http://localhost:3029";

class OfficeFloor28BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 28 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 28 Beacon System
const beaconSystem = new OfficeFloor28BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 28 Beacon System...");
