...
class OfficeFloor6SensorController {
  constructor() {
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 6 Sensor Controller connected to MQTT");
  ...
  triggerAlert(sensorId, alert) {
    ...
    console.log(
      `Office Floor 6 ALERT TRIGGERED: ${alert.type} - ${alert.severity}`
    );
...
// Start the Office Floor 6 Sensor Controller
const controller = new OfficeFloor6SensorController();
...
export default OfficeFloor6SensorController;
