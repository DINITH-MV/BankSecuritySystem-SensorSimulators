...
class OfficeFloor6ActuatorController {
  constructor() {
    this.zone = "office_floor_6";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF6_001: {
          id: "SIREN_OF6_001",
          location: "Office Floor 6 Corridor North",
          active: false,
        },
        SIREN_OF6_002: {
          id: "SIREN_OF6_002",
          location: "Office Floor 6 Corridor South",
          active: false,
        },
        SIREN_OF6_003: {
          id: "SIREN_OF6_003",
          location: "Office Floor 6 Corridor East",
          active: false,
        },
        SIREN_OF6_004: {
          id: "SIREN_OF6_004",
          location: "Office Floor 6 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_6_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 6 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_6/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 6");
...
// Start the Office Floor 6 Actuator Controller
const controller = new OfficeFloor6ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 6 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor6ActuatorController;
