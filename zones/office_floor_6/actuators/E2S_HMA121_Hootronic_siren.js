...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 6 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF6_001", location: "Office Floor 6 Corridor North" },
  { sirenId: "SIREN_OF6_002", location: "Office Floor 6 Corridor South" },
  { sirenId: "SIREN_OF6_003", location: "Office Floor 6 Corridor East" },
  { sirenId: "SIREN_OF6_004", location: "Office Floor 6 Corridor West" },
];

const serverUrl = "http://localhost:3007";

class OfficeFloor6SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 6 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3007");
      } else {
...
// Start the Office Floor 6 Siren System
const sirenSystem = new OfficeFloor6SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 6 Siren System...");
