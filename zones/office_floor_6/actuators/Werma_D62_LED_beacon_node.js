...
/**
 * Werma D62 LED Beacon - Office Floor 6
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF6_001", location: "Office Floor 6 Corridor North" },
  { beaconId: "BEACON_OF6_002", location: "Office Floor 6 Corridor South" },
  { beaconId: "BEACON_OF6_003", location: "Office Floor 6 Corridor East" },
  { beaconId: "BEACON_OF6_004", location: "Office Floor 6 Corridor West" },
];

const serverUrl = "http://localhost:3007";

class OfficeFloor6BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 6 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 6 Beacon System
const beaconSystem = new OfficeFloor6BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 6 Beacon System...");
