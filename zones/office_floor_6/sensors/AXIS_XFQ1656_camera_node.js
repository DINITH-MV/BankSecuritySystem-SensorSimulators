...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF6_001", location: "Office Floor 6 Main Entrance" },
  { sensorId: "CAM_OF6_002", location: "Office Floor 6 Reception Area" },
  { sensorId: "CAM_OF6_003", location: "Office Floor 6 Open Office Area A" },
  { sensorId: "CAM_OF6_004", location: "Office Floor 6 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 6 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 6 Camera Nodes...");
