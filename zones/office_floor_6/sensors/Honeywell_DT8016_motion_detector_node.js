...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF6_016",
    location: "Office Floor 6 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF6_017",
    location: "Office Floor 6 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 6..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 6 Honeywell Motion Detector Nodes..."
  );
