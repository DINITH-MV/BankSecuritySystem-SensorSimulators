...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 22 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF22_001", location: "Office Floor 22 Corridor North" },
  { sirenId: "SIREN_OF22_002", location: "Office Floor 22 Corridor South" },
  { sirenId: "SIREN_OF22_003", location: "Office Floor 22 Corridor East" },
  { sirenId: "SIREN_OF22_004", location: "Office Floor 22 Corridor West" },
];

const serverUrl = "http://localhost:3023";

class OfficeFloor22SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 22 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3023");
      } else {
...
// Start the Office Floor 22 Siren System
const sirenSystem = new OfficeFloor22SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 22 Siren System...");
