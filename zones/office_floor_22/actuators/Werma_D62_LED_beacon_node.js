...
/**
 * Werma D62 LED Beacon - Office Floor 22
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF22_001", location: "Office Floor 22 Corridor North" },
  { beaconId: "BEACON_OF22_002", location: "Office Floor 22 Corridor South" },
  { beaconId: "BEACON_OF22_003", location: "Office Floor 22 Corridor East" },
  { beaconId: "BEACON_OF22_004", location: "Office Floor 22 Corridor West" },
];

const serverUrl = "http://localhost:3023";

class OfficeFloor22BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 22 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 22 Beacon System
const beaconSystem = new OfficeFloor22BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 22 Beacon System...");
