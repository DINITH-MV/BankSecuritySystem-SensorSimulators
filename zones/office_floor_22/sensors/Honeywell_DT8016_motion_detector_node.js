...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF22_016",
    location: "Office Floor 22 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF22_017",
    location: "Office Floor 22 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 22..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 22 Honeywell Motion Detector Nodes..."
  );
