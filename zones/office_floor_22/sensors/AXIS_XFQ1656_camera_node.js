...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF22_001", location: "Office Floor 22 Main Entrance" },
  { sensorId: "CAM_OF22_002", location: "Office Floor 22 Reception Area" },
  { sensorId: "CAM_OF22_003", location: "Office Floor 22 Open Office Area A" },
  { sensorId: "CAM_OF22_004", location: "Office Floor 22 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 22 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 22 Camera Nodes...");
