...
class OfficeFloor22ActuatorController {
  constructor() {
    this.zone = "office_floor_22";
    this.serverUrl = "http://localhost:3023";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF22_001: {
          id: "SIREN_OF22_001",
          location: "Office Floor 22 Corridor North",
          active: false,
        },
        SIREN_OF22_002: {
          id: "SIREN_OF22_002",
          location: "Office Floor 22 Corridor South",
          active: false,
        },
        SIREN_OF22_003: {
          id: "SIREN_OF22_003",
          location: "Office Floor 22 Corridor East",
          active: false,
        },
        SIREN_OF22_004: {
          id: "SIREN_OF22_004",
          location: "Office Floor 22 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_22_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 22 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_22/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 22");
...
// Start the Office Floor 22 Actuator Controller
const controller = new OfficeFloor22ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 22 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor22ActuatorController;
