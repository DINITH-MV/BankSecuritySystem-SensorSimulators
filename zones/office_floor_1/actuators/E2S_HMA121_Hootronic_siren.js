...
/**
 * E2S HMA121 Hootronic Horn - Office Floor 1 Siren
 * Web server controlled high-power indoor siren system
 */

const SIREN_CONFIGS = [
  { sirenId: "SIREN_OF1_001", location: "Office Floor 1 Corridor North" },
  { sirenId: "SIREN_OF1_002", location: "Office Floor 1 Corridor South" },
  { sirenId: "SIREN_OF1_003", location: "Office Floor 1 Corridor East" },
  { sirenId: "SIREN_OF1_004", location: "Office Floor 1 Corridor West" },
];

const serverUrl = "http://localhost:3002";

class OfficeFloor1SirenSystem {
  constructor() {
    this.sirens = {};
    ...
    console.log(
      "Office Floor 1 Siren System initialized with web server control"
    );
  ...
  async sendSirenDataToServer(sirenData) {
    try {
      ...
      if (error.response) {
        ...
        console.error("Make sure the web server is running on port 3002");
      } else {
...
// Start the Office Floor 1 Siren System
const sirenSystem = new OfficeFloor1SirenSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 1 Siren System...");
