...
/**
 * Werma D62 LED Beacon - Office Floor 1
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF1_001", location: "Office Floor 1 Corridor North" },
  { beaconId: "BEACON_OF1_002", location: "Office Floor 1 Corridor South" },
  { beaconId: "BEACON_OF1_003", location: "Office Floor 1 Corridor East" },
  { beaconId: "BEACON_OF1_004", location: "Office Floor 1 Corridor West" },
];

const serverUrl = "http://localhost:3002";

class OfficeFloor1BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 1 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 1 Beacon System
const beaconSystem = new OfficeFloor1BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 1 Beacon System...");
