...
class OfficeFloor1ActuatorController {
  constructor() {
    this.zone = "office_floor_1";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF1_001: {
          id: "SIREN_OF1_001",
          location: "Office Floor 1 Corridor North",
          active: false,
        },
        SIREN_OF1_002: {
          id: "SIREN_OF1_002",
          location: "Office Floor 1 Corridor South",
          active: false,
        },
        SIREN_OF1_003: {
          id: "SIREN_OF1_003",
          location: "Office Floor 1 Corridor East",
          active: false,
        },
        SIREN_OF1_004: {
          id: "SIREN_OF1_004",
          location: "Office Floor 1 Corridor West",
          active: false,
        },
      },
      beacons: {
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 1 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_1/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 1");
...
// Start the Office Floor 1 Actuator Controller
const controller = new OfficeFloor1ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 1 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor1ActuatorController;
