...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF1_016",
    location: "Office Floor 1 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF1_017",
    location: "Office Floor 1 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 1..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 1 Honeywell Motion Detector Nodes..."
  );
