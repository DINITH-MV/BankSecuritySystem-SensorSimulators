...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF1_001", location: "Office Floor 1 Main Entrance" },
  { sensorId: "CAM_OF1_002", location: "Office Floor 1 Reception Area" },
  { sensorId: "CAM_OF1_003", location: "Office Floor 1 Open Office Area A" },
  { sensorId: "CAM_OF1_004", location: "Office Floor 1 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 1 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 1 Camera Nodes...");
