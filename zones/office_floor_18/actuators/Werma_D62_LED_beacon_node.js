...
/**
 * Werma D62 LED Beacon - Office Floor 18
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF3_001", location: "Office Floor 18 Corridor North" },
  { beaconId: "BEACON_OF3_002", location: "Office Floor 18 Corridor South" },
  { beaconId: "BEACON_OF3_003", location: "Office Floor 18 Corridor East" },
  { beaconId: "BEACON_OF3_004", location: "Office Floor 18 Corridor West" },
];

const serverUrl = "http://localhost:3019";

class OfficeFloor18BeaconSystem {
  constructor() {
    this.beacons = {};
    ...
    console.log(
      "Office Floor 18 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 18 Beacon System
const beaconSystem = new OfficeFloor18BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 18 Beacon System...");
