...
class OfficeFloor18ActuatorController {
  constructor() {
    this.zone = "office_floor_3";
    this.serverUrl = "http://localhost:3019";
    ...
    this.actuators = {
      sirens: {
        SIREN_OF3_001: {
          id: "SIREN_OF3_001",
          location: "Office Floor 18 Corridor North",
          active: false,
        },
        SIREN_OF3_002: {
          id: "SIREN_OF3_002",
          location: "Office Floor 18 Corridor South",
          active: false,
        },
        SIREN_OF3_003: {
          id: "SIREN_OF3_003",
          location: "Office Floor 18 Corridor East",
          active: false,
        },
        SIREN_OF3_004: {
          id: "SIREN_OF3_004",
          location: "Office Floor 18 Corridor West",
          active: false,
        },
      },
      beacons: {
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 18 Actuator Controller connected to MQTT");
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 18");
...
// Start the Office Floor 18 Actuator Controller
const controller = new OfficeFloor18ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 18 Actuator Controller...");
  controller.deactivateAllActuators();
  process.exit(0);
});

export default OfficeFloor18ActuatorController;
