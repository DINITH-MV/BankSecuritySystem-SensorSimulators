...
const MOTION_CONFIGS = [
  {
    ...
    location: "Office Floor 18 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF3_017",
    location: "Office Floor 18 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 18..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 18 Honeywell Motion Detector Nodes..."
  );
