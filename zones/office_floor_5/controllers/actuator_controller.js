...
class OfficeFloor3ActuatorController {
  constructor() {
    ...
    this.actuators = {
      sirens: {
        SIREN_OF5_001: {
          id: "SIREN_OF5_001",
          location: "Office Floor 5 Corridor North",
          active: false,
        },
        SIREN_OF5_002: {
          id: "SIREN_OF5_002",
          location: "Office Floor 5 Corridor South",
          active: false,
        },
        SIREN_OF5_003: {
          id: "SIREN_OF5_003",
          location: "Office Floor 5 Corridor East",
          active: false,
        },
        SIREN_OF5_004: {
          id: "SIREN_OF5_004",
          location: "Office Floor 5 Corridor West",
          active: false,
        },
      },
      beacons: {
    ...
    const mqttOptions = {
      ...
      clientId: `office_floor_5_${Math.random().toString(16).substr(2, 8)}`,
      clean: true,
      connectTimeout: 4000,
  ...
  setupMQTT() {
    this.mqttClient.on("connect", () => {
      console.log("Office Floor 5 Actuator Controller connected to MQTT");
  ...
  subscribeToStatusTopic() {
    const statusTopic = "bank_security/zone/office_floor_5/actuators/status";
  ...
  async deactivateAllActuators() {
    console.log("Deactivating all actuators in Office Floor 5");
...
// Start the Office Floor 5 Actuator Controller
const controller = new OfficeFloor3ActuatorController();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 5 Actuator Controller...");
