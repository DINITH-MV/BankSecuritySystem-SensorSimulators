...
const MOTION_CONFIGS = [
  {
    sensorId: "MOTION_OF5_016",
    location: "Office Floor 5 Main Entrance Foyer",
  },
  {
    sensorId: "MOTION_OF5_017",
    location: "Office Floor 5 Reception Checkpoint",
  },
];
...
console.log(
  "Starting Honeywell DT8016 DualTech Motion Detector for Office Floor 5..."
);
...
process.on("SIGINT", () => {
  console.log(
    "\nShutting down Office Floor 5 Honeywell Motion Detector Nodes..."
  );
