...
const CAMERA_CONFIGS = [
  { sensorId: "CAM_OF5_001", location: "Office Floor 5 Main Entrance" },
  { sensorId: "CAM_OF5_002", location: "Office Floor 5 Reception Area" },
  { sensorId: "CAM_OF5_003", location: "Office Floor 5 Open Office Area A" },
  { sensorId: "CAM_OF5_004", location: "Office Floor 5 Open Office Area B" },
];
...
console.log(
  "Starting AXIS XFQ1656 Camera monitoring for Office Floor 5 cameras..."
);
...
// Graceful shutdown
process.on("SIGINT", () => {
  console.log("\nShutting down Office Floor 5 Camera Nodes...");
