...
/**
 * Werma D62 LED Beacon - Office Floor 5
 * Web server controlled LED beacon system
 */

const BEACON_CONFIGS = [
  { beaconId: "BEACON_OF5_001", location: "Office Floor 5 Corridor North" },
  { beaconId: "BEACON_OF5_002", location: "Office Floor 5 Corridor South" },
  { beaconId: "BEACON_OF5_003", location: "Office Floor 5 Corridor East" },
  { beaconId: "BEACON_OF5_004", location: "Office Floor 5 Corridor West" },
];
...
class OfficeFloor3BeaconSystem {
  constructor() {
    ...
    console.log(
      "Office Floor 5 Beacon System initialized with web server control"
    );
...
// Start the Office Floor 5 Beacon System
const beaconSystem = new OfficeFloor3BeaconSystem();

// Graceful shutdown
process.on("SIGINT", () => {
  console.log("Shutting down Office Floor 5 Beacon System...");
